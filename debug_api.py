...
async def create_video(image_file: UploadFile = File(...),
    ...
    ref_video: str = None
    input_yaw_list: list = [5, -1, 1]
    input_pitch_list: list = [-3, 2, 0]
    input_roll_list: list = [1, -1, 0]
...
# curl -X POST -F "image_file=@/Users/weizy/PycharmProjects/pythonProject/media/art_5_256x256.png" -F "audio_file=@/Users/weizy/PycharmProjects/pythonProject/media/RD_Radio31_000.wav" http://localhost:8008/create_video -o output_test.mp4
