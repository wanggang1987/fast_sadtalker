...
def make_animation(source_image, source_semantics, target_semantics,
    ...
    with torch.no_grad():
        ...
        # if target_semantics.shape[1] % 2 == 0:
        #     pbar =tqdm(range(1, target_semantics.shape[1], 2), 'Face Renderer:')
        # else:
        #     pbar =tqdm(range(0, target_semantics.shape[1], 2), 'Face Renderer:')
        pbar =tqdm(range(target_semantics.shape[1]), 'Face Renderer:')
